...
export const LinkListLink = ({
  ...
  const linkContent = (
    <>
      ...
      <span className="text-base items-center flex justify-between font-semibold tracking-tight py-4 pr-4 after:h-[1px] after:w-full after:absolute after:bg-gray-200 after:bottom-0 group-last:after:hidden flex-1 overflow-hidden">
