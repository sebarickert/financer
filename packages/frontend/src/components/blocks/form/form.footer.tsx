...
export const FormFooter = ({
  ...
  return (
    <>
      <div className="py-4 fixed lg:static left-0 right-0 bottom-[calc(56px+env(safe-area-inset-bottom))] px-4 lg:bg-transparent lg:mt-8 lg:px-0 border-t border-gray-dark">
