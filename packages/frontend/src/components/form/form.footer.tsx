...
export const FormFooter = ({
  ...
  return (
    <>
      <div className="py-4 fixed lg:static left-0 right-0 bottom-[calc(44px+env(safe-area-inset-bottom))] px-4 bg-white lg:bg-transparent lg:mt-8 border-t lg:px-0">
